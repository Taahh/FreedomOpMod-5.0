...
public class RankManager extends FreedomService
{
    ...
    public void fCmdSpy(FPlayer fPlayer) {
    ...
    public Displayable getDisplay(CommandSender sender)
    {
        ...
        //
        if (FUtil.SPEC_EXEC.contains(player.getName())) {
            return Title.SPEC_EXEC;
        }
        if (FUtil.FOP_WEBDEV.contains(player.getName())) {
            return Title.FOP_WEBDEV;
        }
        if (FUtil.FOP_DEV.contains(player.getName())) {
            return Title.FOP_DEV;
        }
